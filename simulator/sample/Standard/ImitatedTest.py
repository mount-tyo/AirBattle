...
from ASRCAISim1.addons.rayUtility.extension.agents.marwil import RNNMARWILTorchPolicy,RNNMARWILTFPolicy
...
def main(base_config_j,weight_path):
	...
	policyClass=RNNMARWILTorchPolicy if tc.get("framework")=="torch" else RNNMARWILTFPolicy
